    ...
    fun uploadClick(view: View){
        ...
        if (selectedPicture != null){
            imagesreference.putFile(selectedPicture!!).addOnSuccessListener { taskSnapshot ->
                ...
                //Database
                val uploaderPictureReference = FirebaseStorage.getInstance().reference.child("images").child(imageName)
                uploaderPictureReference.downloadUrl.addOnSuccessListener { uri ->
